...
<html>
	...
	<body>
        ...
        <form action="altera_recebe_dados.php" method="POST">
            <h2>Atualizar dados</h2><br><br>           
            ...
            <p><a href="perfilmeu.php"><button>Voltar</button></a>&nbsp;&nbsp;<input type="submit" value="Enviar!" onclick="if (!confirm('Tem certeza de que deseja alterar essas informações?')) return false;"></p>
