...
/*
    Função que vai armazenar no servidor a imagem contida no parâmetro $fileToUpload.
...
function upload_publicacao($fileToUpload){
    $target_dir = "publicacao/"; // pasta do servidor onde as imagens devem ser salvas
    $uploadOk = 1;
